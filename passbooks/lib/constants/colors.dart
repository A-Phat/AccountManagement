...
class MaterialColors {
  ...
  static const Color appBar = Color.fromRGBO(229, 204, 255, 1.0);

  static const Color sunday = Color.fromRGBO(205,92,92, 1.0);
  static const Color monday = Color.fromRGBO(238,232,170, 1.0);
  static const Color tuesday = Color.fromRGBO(221,160,221, 1.0);
  static const Color wednesday = Color.fromRGBO(32,178,170, 1.0);
  static const Color thursday = Color.fromRGBO(255,160,122, 1.0);
  static const Color friday = Color.fromRGBO(135,206,250, 1.0);
  static const Color saturday = Color.fromRGBO(147,112,219, 1.0);
